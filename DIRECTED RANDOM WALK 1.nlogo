...
Turtles : 
They would act like the particles/people.
...
When different groups meet each other, they will start an "turtle exchange" that most of the time will end up with both groups converging.

If **VISION** is high enough, the turtles will create just one big group.
